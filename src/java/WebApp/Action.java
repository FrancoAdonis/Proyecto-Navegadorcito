...
public class Action extends ActionSupport {
    ...
    public String filtrarInscripcion() {
        ...
        this.listarInscripcion = InscripcionAsignaturaFCD.listarAsignaturasInscritas(Integer.parseInt(usuRut), insAnnio, insSemestre,estAprobado);
        }
        else{
            this.listarInscripcionDTO = Controler.listarInscripcionAlumnoDTO(Integer.parseInt(usuRut));         
        }
    ...
    public String buscarInscripcionAsignatura() {
        ...
        if (objCarreraEstudiante != null) { 
            ...
            this.listarAsignatura = AsignaturaFCD.listarAsignaturaNoInscrita(codCarreraV, rutUsuario); 
    ...
    /*    public String buscarInscripcionAsignatura() {
         //   AGREGAR POR RUT O BUSCAR ASIGNATURA ESPECIFICA A MODIFICAR ELIMINAR!!!
        ...
        this.mensaje = "";
        this.listarAsignaturaMalla = AsignaturaFCD.listarAsignatura(); 
        this.listarInscripcion = InscripcionAsignaturaFCD.listarInscripcionAlumno(rutUsuario);   
        this.insAnnio       = 2017;
        this.insSemestre    = 2;   
        CarreraEstudiante objCarreraEstudiante = CarreraEstudianteFCD.getCarreraEstudiante(rutUsuario);
        if (objCarreraEstudiante != null) { 
