...
<body onload="escondeBloque('bloque_buscar',1);">
	...
	<section>
		<article>
		<form name="formBuscar" id="formBuscar" action="buscarCarrera.action" method="POST" class="frm_nuevo"> 
                    <div>
                        <ul>
                            <li>
                                <h2>Ingrese código carrera a buscar</h2>
                            </li>
                    <li>
                ...
                <s:iterator value="listarCarrera">
                    <option value="${codCarrera}" ${codCarrera == codCarreraV?'selected="selected"':'0'}>${nomCarrera}</option>
                     ...
                     <button class="submit" type="submit">Buscar Carrera</button>
		     </li> 
			</ul>
		    </div>
                ...
                <article><div>                    
                    Ver Lista de Carreras existentes&nbsp;&nbsp;<a onClick="javascript:escondeBloque('bloque_buscar',2)"><img src="images/if_Zoom In_27888.png" alt="" width="20px" height="20px" ></a>&nbsp;<a onClick="javascript:escondeBloque('bloque_buscar',1)"><img src="images/if_Zoom Out_27889.png" alt="" width="20px" height="20px" ></a></li>			
                    </div>
                    <div id="bloque_buscar">
                        <table border ="1">
                    <tr>
                        <td width="20%" style="text-align: center"><b>Código Carrera</b></td>
                        <td width="20%" style="text-align: center"><b>Nombre Carrera</b></td>
                    </tr>

                    <s:iterator value="listarCarrera">
                    <tr>
                        <td width="20%" style="text-align: center"><s:property value="codCarrera" /></td>
                        <td width="20%"><s:property value="nomCarrera"/></td>
                    </tr>
                    </s:iterator>
                    </table>                      
                    </div>                                    
		            ...
		            <ul>
		                ...
		                <li>
		                    <label for="lblCodigoC">Código Carrera</label>
                                    <input value="${codCarreraV}" type="text" placeholder="280" name="codCarreraV" id="codCarreraV" required />

		                </li>
						<li>
		                    <label for="lblNombreC">Nombre Carrera</label>
                                <input value="${nomCarrera}" type="text" placeholder="Ingenieria Planetaria" name="nomCarrera" id="nomCarrera" required/>                                    		                    
		                </li>
						<li>
                    <button class="submit" type="button" name="eliminar" value="eliminar" onClick="javascript:enviar('eliminarCarrera.action')">Eliminar Carrera</button>
                    <button class="submit" type="button" name="modificar" value="modificar" onClick="javascript:enviar('modificarCarrera.action')">Modificar Carrera</button>
                    <button class="submit" type="button" name="agregar" value="agregar" onClick="javascript:enviar('agregarCarrera.action')">Insertar Carrera</button>                                   
		                </li>
