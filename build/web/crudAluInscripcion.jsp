...
<section>                    
            ...
            <form name="formAccion" action="" method="POST" class="frm_nuevo">  
                    ...
                    <tr>
                        <td width="5%" style="vertical-align: top">Año:&nbsp;<input maxlength="4" style="width : 40px; heigth : 0.2px" value="${insAnnio}" type="text"  name="insAnnio" id="insAnnio" /></td>
                        <td width="5%">Semestre:&nbsp;<input maxlength="1" style="width : 10px; heigth : 0.2px" value="${insSemestre}" type="text" name="insSemestre" id="insSemestre" /></td>
                        <td width="10%">Estado:&nbsp;<select id="estAprobado" name="estAprobado" class="form_hint">
